...
基于单目反应马尔科夫控制的可转换策略的学习[Learning Transferable Policies for Monocular Reactive MAV Control](./ML Papers/Learning Transferable Policies for Monocular Reactive MAV Control.md)  
# 机器学习理论
## 经典算法
线性回归模型    
逻辑斯蒂回归模型    
